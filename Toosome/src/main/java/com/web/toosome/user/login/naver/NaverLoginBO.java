package com.web.toosome.user.login.naver;
...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "8r4r1srYswjZZzvvy65B";
	private final static String CLIENT_SECRET = "Df1kWmE9aU";
	private final static String REDIRECT_URI = "http://ec2-13-125-224-136.ap-northeast-2.compute.amazonaws.com/nsignproc";
