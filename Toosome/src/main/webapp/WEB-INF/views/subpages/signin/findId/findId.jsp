...
<head>
  ...
  <link rel="stylesheet" href="/resources/css/subpages/signin/findId/findId.css">
  ...
  <div id="container">
	...
	<section>
       	<div class="info">
       		...
       		<h3>잠깐!</h3>
       		<p>투썸플레이스는 고객님의 이메일을 아이디로 사용하고 있습니다.<br>
       		먼저, 사용했을 만한 이메일로 <a href="/signin">로그인</a>을 시도해보세요.</p><br>
       		<p>계정을 찾으려면 사용했을 만한 이메일, 이름으로 검색하세요.</p>
       	</div>
