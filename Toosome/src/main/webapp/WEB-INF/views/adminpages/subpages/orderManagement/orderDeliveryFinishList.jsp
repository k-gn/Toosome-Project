...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderDeliveryFinishList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.0.1/js/tempusdominus-bootstrap-4.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderDeliveryFinishList.js" defer></script>
</head>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class=card-title>배송완료 리스트</h4>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderDeliveryFinishList" items="${orderDeliveryFinishList}">
	                        <tr>
	                          <td>
	                            ${orderDeliveryFinishList.orderId}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.orderState}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.ordererId}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.ordererName}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderDeliveryFinishList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
