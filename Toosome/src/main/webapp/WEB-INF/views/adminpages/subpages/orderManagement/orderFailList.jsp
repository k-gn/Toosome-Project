...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderFailList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderFailList.js" defer></script>
</head>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class=card-title>결제 중단/실패 리스트</h4>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderFailList" items="${orderFailList}">
	                        <tr>
	                          <td>
	                            ${orderFailList.orderId}
	                          </td>
	                          <td>
	                            ${orderFailList.orderState}
	                          </td>
	                          <td>
	                            ${orderFailList.ordererId}
	                          </td>
	                          <td>
	                            ${orderFailList.ordererName}
	                          </td>
	                          <td>
	                            ${orderFailList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderFailList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderFailList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
