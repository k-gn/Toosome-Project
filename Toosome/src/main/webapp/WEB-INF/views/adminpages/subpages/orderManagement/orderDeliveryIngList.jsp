...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderDeliveryIngList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderDeliveryIngList.js" defer></script>
</head>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class=card-title>배송중 리스트</h4>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderDeliveryIngList" items="${orderDeliveryIngList}">
	                        <tr>
	                          <td>
	                            ${orderDeliveryIngList.orderId}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.orderState}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.ordererId}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.ordererName}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderDeliveryIngList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
