		                    ...
		                    <div class="row">
		                      <div class="col-md-12">
		                        <div class="form-group">
		                          ...
		                          <input type="text" name="newsBoardTitle" class="form-control">
		                        </div>
		                      </div>
		                    </div>
		                    <div class="row">
			  ...
			  <div class="modal-dialog modal-signup" role="document">
			    <div class="modal-content">
			      <div class="card card-signup card-plain">
			        ...
			        <form id="enroll-form" action="/admin/newsboard-insert?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
				        <div class="modal-body">
				              ...
				              <div class="info info-horizontal">
				                <div class="description">
				                  ...
				                  <div class="input-group">
				                      <input type="text" name="newsBoardId" class="form-control" placeholder="제목을 입력하세요">
				                  </div>
				                </div>
				                </div>
				              </div>
				          ...
				          <button id="enroll-submit" type="submit" class="btn btn-primary pull-right">업데이트</button>
