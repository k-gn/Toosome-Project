...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderProductReadyList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderProductReadyList.js" defer></script>
</head>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderProductReadyList" items="${orderProductReadyList}">
	                        <tr>
	                          <td>
	                            ${orderProductReadyList.orderId}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.orderState}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.ordererId}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.ordererName}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderProductReadyList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
