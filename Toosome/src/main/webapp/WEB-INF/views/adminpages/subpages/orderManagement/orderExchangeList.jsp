...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderExchangeList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.0.1/js/tempusdominus-bootstrap-4.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderExchangeList.js" defer></script>
</head>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderExchangeList" items="${orderExchangeList}">
	                        <tr>
	                          <td>
	                            ${orderExchangeList.orderId}
	                          </td>
	                          <td>
	                            ${orderExchangeList.orderState}
	                          </td>
	                          <td>
	                            ${orderExchangeList.ordererId}
	                          </td>
	                          <td>
	                            ${orderExchangeList.ordererName}
	                          </td>
	                          <td>
	                            ${orderExchangeList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderExchangeList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderExchangeList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
