...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderConfirmFinishList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderConfirmFinishList.js" defer></script>
</head>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class=card-title>기프티콘 리스트</h4>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderConfirmFinishList" items="${orderConfirmFinishList}">
	                        <tr>
	                          <td>
	                            ${orderConfirmFinishList.orderId}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.orderState}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.ordererId}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.ordererName}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderConfirmFinishList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
