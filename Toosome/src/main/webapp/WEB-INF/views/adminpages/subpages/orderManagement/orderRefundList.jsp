...
<head>
  ...
  <link href="/resources/css/adminpages/subpages/orderManagement/orderRefundList.css" rel="stylesheet" />
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
  <script src="/resources/js/adminpages/subpages/orderManagement/orderRefundList.js" defer></script>
</head>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="member-table" class="table">
                      ...
                      <tbody>
                     	 <c:forEach var="orderRefundList" items="${orderRefundList}">
	                        <tr>
	                          <td>
	                            ${orderRefundList.orderId}
	                          </td>
	                          <td>
	                            ${orderRefundList.orderState}
	                          </td>
	                          <td>
	                            ${orderRefundList.ordererId}
	                          </td>
	                          <td>
	                            ${orderRefundList.ordererName}
	                          </td>
	                          <td>
	                            ${orderRefundList.productVO.productName}
	                          </td>
	                          <td>
	                            ${orderRefundList.productVO.productCheckCount}
	                          </td>
	                          <td>
	                            ${orderRefundList.productVO.productPrice}
	                          </td>
	                        </tr>
                        </c:forEach>
                      </tbody>
